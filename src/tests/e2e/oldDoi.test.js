...
'Test Navigation through AddPub - search old DOI'(client) {
    client
      ...
      .assert.containsText(".DoiInfo", "This publication already exists in the database with the following info:")
      .clearValue('#title')
      .useCss().setValue('#title', "Measured Measurements")
      .useXpath().click("//*[contains(text(),'Insert Edited Publication Information')]")    
      ...
      .setValue('.ReactTable .rt-thead.-filters input:nth-of-type(1)', "Measured Measurements")
