...
describe("DoiInfo Component Tests", () => {
  ...
  it("renders with correct empty Form", () => {
    ...
    expect(wrapper.find("FormControl").first().props().placeholder).toBe(
      "Enter Title"
    );
    expect(
      wrapper.find("FormControl").first().props().defaultValue
    ).toBeUndefined();
    ...
    expect(
      wrapper.find("FormControl").at(1).props().defaultValue
    ).toBeUndefined();

    expect(wrapper.find("FormLabel").at(2).text()).toBe("Publisher");
    expect(wrapper.find("FormControl").at(2).props().placeholder).toBe(
      "Enter Publisher"
    );
    expect(
      wrapper.find("FormControl").at(2).props().defaultValue
    ).toBeUndefined();

    expect(wrapper.find("FormLabel").at(3).text()).toBe("Volume");
    expect(wrapper.find("FormControl").at(3).props().placeholder).toBe(
      "Enter Volume"
    );
    expect(
      wrapper.find("FormControl").at(3).props().defaultValue
    ).toBeUndefined();

    expect(wrapper.find("FormLabel").at(4).text()).toBe("URL");
    expect(wrapper.find("FormControl").at(4).props().placeholder).toBe(
      "Enter URL"
    );
    expect(
      wrapper.find("FormControl").at(4).props().defaultValue
    ).toBeUndefined();

    expect(wrapper.find("FormLabel").at(5).text()).toBe("DOI");
    expect(wrapper.find("FormControl").at(5).props().placeholder).toBe(
      "Enter DOI"
    );
    expect(
      wrapper.find("FormControl").at(5).props().defaultValue
    ).toBeUndefined();

    expect(wrapper.find("FormLabel").at(6).text()).toBe("Month of Publication");
    expect(wrapper.find("FormControl").at(6).props().placeholder).toBe(
      "Enter Month (ex. 5)"
    );
    expect(
      wrapper.find("FormControl").at(6).props().defaultValue
    ).toBeUndefined();

    expect(wrapper.find("FormLabel").at(7).text()).toBe("Year of Publication");
    expect(wrapper.find("FormControl").at(7).props().placeholder).toBe(
      "Enter Year (ex. 2000)"
    );
    expect(
      wrapper.find("FormControl").at(7).props().defaultValue
    ).toBeUndefined();

    expect(wrapper.find("FormLabel").at(8).text()).toBe("Abstract");
    expect(wrapper.find("FormControl").at(8).props().placeholder).toBe(
      "Enter Abstract"
    );
    expect(
      wrapper.find("FormControl").at(8).props().defaultValue
    ).toBeUndefined();
  });
  ...
  it("renders with correct filled in form", () => {
    ...
    expect(wrapper.find("FormControl").first().props().defaultValue).toBe(
      "Test"
    );
    ...
    expect(wrapper.find("FormControl").at(1).props().defaultValue).toBe(
      "John Smith"
    );
  ...
  describe("Editing doiInfo", () => {
    ...
    it("should change state when input values change and call handleFieldChange", () => {
      ...
      expect(updateDoiInfo.mock.calls[0][0]["data"]["author"]).toEqual(
        "Changed Author"
      );
      ...
      expect(updateDoiInfo.mock.calls[0][0]["data"]["publisher"]).toEqual(
        "Changed Publisher"
      );
      ...
      expect(updateDoiInfo.mock.calls[0][0]["data"]["url"]).toEqual(
        "www.test.com"
      );
      ...
      expect(updateDoiInfo.mock.calls[0][0]["data"]["doi"]).toEqual(
        "10.1038/nphys1170"
      );
      ...
      expect(updateDoiInfo.mock.calls[0][0]["data"]["abstract"]).toEqual(
        "This is a test"
      );
